function recebeNomeJogador() {
    ...
    m.textContent = "Vamos receber seu nome primeiro para termos um contato mais direto? Conta pra mim aí!";

    var f = document.createElement("form");
    f.setAttribute("method", "post"); 
    f.setAttribute("action", "storytelling.html"); 


    var i = document.createElement("input"); //input element, text
    i.setAttribute('type',"text");
    i.setAttribute('name',"Seunome");
    i.setAttribute("placeholder", "Seu nome");


    var s = document.createElement("input"); 
    s.setAttribute("type", "submit"); 
    s.setAttribute("value", "Vamos lá!");
    ...
    return document.getElementByName("name").value;
...
document.write(recebeNomeJogador());
